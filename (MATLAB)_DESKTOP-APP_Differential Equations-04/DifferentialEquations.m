...
% Last Modified by GUIDE v2.5 04-Jan-2019 17:04:35
...
% Hints: contents = cellstr(get(hObject,'String')) returns popChoose contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popChoose
cla;
xlabel('');
ylabel('');
switch get(findobj(0, 'tag', 'popChoose'), 'Value')
    case 1
...
xlabel('Time (sec)');
ylabel('Force (N)');
set(findobj(0, 'tag', 'text35'), 'String', sprintf('%.6f',F));

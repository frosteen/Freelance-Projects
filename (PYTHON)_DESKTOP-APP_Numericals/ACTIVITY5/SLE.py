...
def main():
    ...
    for i in range(0, 10):
        ...
        for v in range(0, 11):
            withConstMatrix[i].append(float(input("a[row{},col{}]: ".format(i+1, v+1))))
    ...
    print(tabulate(rows, tablefmt="simple", floatfmt=".{}f".format(decimalPlace)))
    ...
    while e >= 0.01:
        ...
        cntr += 1
    print(tabulate(rows, headers=["k","x1","x2","x3","x4","x5","x6","x7","x8","x9","x10"], tablefmt="simple", floatfmt=".{}f".format(decimalPlace)))
    print()
    for i in range(0,10):

...
def RegulaCoeff():
    a0 = float(input("Enter the coefficient for x5: "))
    a1 = float(input("Enter the coefficient for x4: "))
    a2 = float(input("Enter the coefficient for x3: "))
    a3 = float(input("Enter the coefficient for x2: "))
    a4 = float(input("Enter the coefficient for x1: "))
    a5 = float(input("Enter the coefficient for x0: "))
...
def Regula():
    x0 = float(input("Enter the intital value x0: "))
    x1 = float(input("Enter the intital value x1: "))

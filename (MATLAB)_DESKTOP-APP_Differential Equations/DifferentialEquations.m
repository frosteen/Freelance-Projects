...
%DIFFERENTIALEQUATIONS MATLAB code file for DifferentialEquations.fig
...
%
%      DIFFERENTIALEQUATIONS('Property','Value',...) creates a new DIFFERENTIALEQUATIONS using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to DifferentialEquations_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      DIFFERENTIALEQUATIONS('CALLBACK') and DIFFERENTIALEQUATIONS('CALLBACK',hObject,...) call the
%      local function named CALLBACK in DIFFERENTIALEQUATIONS.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 05-Jan-2019 21:27:16
...
v = str2num(get(findobj(0, 'tag', handles), 'String'));

% --- Executes during object creation, after setting all properties.
function popChoose_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popChoose (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
xlabel('r (radius)');
ylabel('Vesc');
set(findobj(0, 'tag', 'text73'), 'String', sprintf('%.6f',vesc));
...
xlabel('t');
ylabel('T');
set(findobj(0, 'tag', 'text48'), 'String', sprintf('%.6f',T));
...
h = 0.001;
for x = 0:h:40
   data = [data, (qi*ci - qo*co)*x]; 
end
plot(0:h:40,  data);
xlabel('t');
ylabel('Q');
set(findobj(0, 'tag', 'text55'), 'String', sprintf('%.6f',Q));
...
set(findobj(0,'tag','uipanel5'), 'Visible', 'off');
set(findobj(0,'tag','uipanel6'), 'Visible', 'off');
set(findobj(0,'tag','uipanel7'), 'Visible', 'off');
...
set(findobj(0,'tag','uipanel5'), 'Visible', 'off');
set(findobj(0,'tag','uipanel6'), 'Visible', 'off');
set(findobj(0,'tag','uipanel7'), 'Visible', 'on');
...
xlabel(''); ylabel('');
set(findobj(0,'tag','uipanel1'), 'Visible', 'off');
set(findobj(0,'tag','uipanel5'), 'Visible', 'on');
set(findobj(0,'tag','uipanel6'), 'Visible', 'off');
set(findobj(0,'tag','uipanel7'), 'Visible', 'off');
...
set(findobj(0,'tag','uipanel1'), 'Visible', 'off');
set(findobj(0,'tag','uipanel5'), 'Visible', 'off');
set(findobj(0,'tag','uipanel6'), 'Visible', 'on');
set(findobj(0,'tag','uipanel7'), 'Visible', 'off');
